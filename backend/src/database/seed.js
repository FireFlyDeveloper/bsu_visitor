...
('Office of the Dean', 'available', '13.948517672120119', '120.72000973110724', 'Academic'),
...
const officeId = db
  .prepare("SELECT id FROM offices WHERE LOWER(office_name) = LOWER(?)")
  .get("office of the dean").id;
...
db.transaction(() => {
  ...
  seedUser.run("Office of the Dean Staff", "staff1", bcrypt.hashSync("secret123", 10), roleId("staff"), officeId);
})();
